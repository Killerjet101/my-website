...
import {SiDiscord, SiTwitter, SiGmail, SiInstagram} from 'react-icons/si';
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-800 dark:text-gray-200 mb-6">
                ...
                or via email. Any other way maybe be a risk of not getting a response. Just an fyi.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:gap-4 mb-20">
                ...
                <div className="row-start-1 md:row-auto">
                    ...
                    <ContactLink
                        ...
                        link="https://twitter.com/Killerjet101"
